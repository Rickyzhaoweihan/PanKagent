...
def test_active_bundle_preserves_original_sources_and_validates_all_checksums():
    ...
    assert router.manifest['bundle_version'] == '1.10.3'
...
def test_saved_qtl_negative_claims_have_source_specific_prompt_boundaries(monkeypatch, tmp_path):
    ...
    async def check():
        ...
        try:
            ...
            assert prepared.profile['bundle_version'] == '1.10.3'
            ...
            from pankagent_vnext.evidence_context import node_only_evidence
            monkeypatch.setattr('pankagent_vnext.llm.compact_evidence', node_only_evidence)
